...
public class UploadService {
    ...
    private static final String UPLOAD_DIRECTORY = "uploadedExcelFiles";
     ...
     */
	public static void uploadFiles(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException  {
